...
namespace PrintCompany.Data.Migrations
{
    ...
    [Migration("20190822135257_OrderNotesAndOrderLinePriceAdded")]
    partial class OrderNotesAndOrderLinePriceAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PrintCompany.Core.Order", b =>
                {
                    ...
                    b.Property<DateTime?>("ColectionDate");
                    ...
                    b.Property<string>("RelatedOrderNote");
            ...
            modelBuilder.Entity("PrintCompany.Core.OrderCustomerContact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("OrderCustomerContacts");
                });
            ...
            modelBuilder.Entity("PrintCompany.Core.OrderCustomerContact", b =>
                {
                    ...
                    b.HasOne("PrintCompany.Core.Order")
                        .WithMany("OrderCustomerContacts")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
